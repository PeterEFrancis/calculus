...
\textbf{scalar multiplication} & $c z_1=(cx_1)+i(cy_1)$\\
\textbf{multiplication} & $z_1 \cdot z_2=(x_1x_2- y_1y_2)+i(x_1y_2+y_1x_2)$\\
\textbf{division} ($z_2\ne 0$) & $\displaystyle\frac{z_1}{z_2}=\left(\frac{x_1x_2+y_1y_2}{x_2^2+y_2^2}\right)+i\left(\frac{x_2y_1-x_1y_2}{x_2^2+y_2^2}\right)$\\
\bottomrule[0.4mm]
\end{tabular}
\end{center}
