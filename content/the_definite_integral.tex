...
$$T_n=\sum_{k=1}^{n}\frac{f\left(a+(k-1)\frac{b-a}{n}\right)+f\left(a+k\frac{b-a}{n}\right)}{2}\frac{b-a}{n}=\frac{R_n+L_n}{2},$$
...
\begin{thm}[The Fundamental Theorem of Calculus]
    If $f$ is continuous on $[a,b]$ and $F$ is continuous on $[a,b]$ with
    $F'=f$ on $(a,b)$, then
